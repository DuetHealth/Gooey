...
public extension GooeyNamespace where Base: NSLayoutXAxisAnchor {
    ...
    func constraintEqualToSystemSpacingBefore(_ anchor: NSLayoutXAxisAnchor, multiplier: CGFloat = 1) -> NSLayoutConstraint {
    ...
    func guide(to other: NSLayoutXAxisAnchor, in view: UIView) -> UILayoutGuide {
...
public extension GooeyNamespace where Base: NSLayoutYAxisAnchor {
    ...
    func constraintEqualToSystemSpacingAbove(_ anchor: NSLayoutYAxisAnchor, multiplier: CGFloat = 1) -> NSLayoutConstraint {
        return base.constraint(equalTo: anchor, constant: multiplier * -CGFloat.goo.systemSpacing)
    }
    
    func constraintLessThanOrEqualToSystemSpacingAbove(_ anchor: NSLayoutYAxisAnchor, multiplier: CGFloat = 1) -> NSLayoutConstraint {
        return base.constraint(lessThanOrEqualTo: anchor, constant: multiplier * -CGFloat.goo.systemSpacing)
    }
    
    /// Creates and returns a layout guide with leading and trailing anchors constrained between this
    /// anchor and the argument anchor contained within the specified view.
    func guide(to other: NSLayoutYAxisAnchor, in view: UIView) -> UILayoutGuide {
        let guide = UILayoutGuide()
        view.addLayoutGuide(guide)
